# Spec: query-mode-detection

## Purpose

Detects the input mode from user text and routes to the appropriate Gemini prompt. Also covers transcript indexing reliability (stale cache and FTS5 error handling).
