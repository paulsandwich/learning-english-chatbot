...
Defines the response format for `term` mode (inputs ≤ 4 words): single words, compound nouns, and phrasal verbs. Includes KK phonetic transcription on the first line.
